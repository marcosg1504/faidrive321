...
class UsuarioRol {
    ...
    public function cargar(){
        ...
        //echo "sentencia sql en cargar de USROL".$sql;
    ...
    public function insertar(){ 
     ...
     // echo "SENTENCIA EN INSERTAR USROL:".$sql;
        if ($base->Iniciar()) {
    ...
    public function modificar(){// este creo q esta bien
        $resp = false;
        $base=new BaseDatos();
        $row= $base->registro();
        $usuario=new Usuario;
        $rol= new Rol;
        $usuario->modificar($row['idusuario']);
        $rol->modificar($row['idrol']);
        $sql=" UPDATE usuariorol SET ";
        $sql.=" idrol = ".$this->getObjRol()->getIdrol();
